...
import { getAllclass, getAllStudent, getAllTeacher, getoneClass, getoneStudent, getoneTeacher, PostClass, PostStudent, PostTeacher  } from "../controller/School.controller";
...
import{
    ...
    }   from '../Zod_Schema/School.zod.schema'
import { UserLogin, Userregister } from "../Zod_Schema/user.zod.schema";
